...
<body>
    ...
    <div class="container-fluid">
        ...
        <form name="account" id="addAccount" action="doAddAccount.php" method="post"  onsubmit="return check();">
            <div class="form-group">
                <label for="username" class="sr-only">账号名称:</label>
                <input type="text" class="form-control" id="username" placeholder="输入新的账号名称" name="username" required autofocus>
            </div>
            <div class="form-group">
                <label for="userpasssword" class="sr-only">设置密码:</label>
                <input type="password" class="form-control" id="userpassword" placeholder="设置密码" username="userpassword" required>
            </div>
            <div class="form-group">
                <label for="userpasssword" class="sr-only">确认密码:</label>
                <input type="password" class="form-control" id="repassword" placeholder="确认密码" name="repassword" required>
            </div>
            <div class="checkbox">
                <label>
                    <input type="checkbox" name="ck_User"> 设置为管理员账号
                </label>
            </div>
